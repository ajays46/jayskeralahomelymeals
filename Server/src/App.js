...
import maxKitchenV1Routes from './modules/max_kitchen/routes/v1/index.js';
import maxRouteV1Routes from './modules/max_route/routes/v1/index.js';
import jaiceV1Routes from './modules/jaice/routes/v1/index.js';
import { extractApiVersion } from './middleware/apiVersion.js';

import authRoutes from './modules/shared/routes/auth.routes.js';
import adminRoutes from './modules/shared/routes/admin.routes.js';
import addressRoutes from './modules/shared/routes/auth.address.route.js';
import externalUploadRoutes from './modules/shared/routes/externalUpload.routes.js';
import financialRoutes from './modules/shared/routes/financial.routes.js';
import deliveryDashboardRoutes from './modules/shared/routes/deliveryDashboard.routes.js';
import cxoRoutes from './modules/shared/routes/cxo.routes.js';
import tenantRoutes from './modules/shared/routes/tenant.routes.js';
