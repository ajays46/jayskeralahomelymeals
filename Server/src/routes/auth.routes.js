...
import { register, login, googleAuth, refreshToken, usersList, forgotPassword, resetPassword, logout, addRoleToUser, removeRoleFromUser, getUserRolesController, checkUserRole, changePassword } from '../controllers/auth.controller.js';
