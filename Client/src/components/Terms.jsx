...
const Terms = ({ isOpen, onClose, compact = false }) => {
  ...
  if (isModal) {
    ...
    return (
      <div className={`fixed inset-0 bg-black bg-opacity-50 z-[110] flex ${compact ? 'items-center justify-end p-2 sm:p-4' : 'items-center justify-center p-4'}`}>
        <div className={`bg-white shadow-lg overflow-y-auto ${compact ? 'w-full max-w-sm max-h-[85vh] rounded-xl' : 'rounded-xl max-w-4xl w-full max-h-[90vh]'}`}>
