...
const RouteHistoryManager = forwardRef(({ 
  ...
  const handleApproveRoute = (routeId) => {
    ...
    showSuccessToast('Route approved successfully');
  };
    ...
    return (
      <div className="mt-4 bg-gray-50 rounded-lg p-4">
        <div className="flex items-center justify-between mb-4">
          <h6 className="text-lg font-semibold text-gray-900">Route Details</h6>
    ...
    <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-6 mb-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center">
            <MdHistory className="w-5 h-5 text-orange-600" />
          </div>
          <div>
            <h3 className="text-xl font-semibold text-gray-900">Draft Routes</h3>
            <p className="text-sm text-gray-500">Manage and approve route planning drafts</p>
          </div>
        </div>
        <div className="flex items-center gap-4">
          <div className="text-right">
            <div className="text-2xl font-bold text-gray-900">{routeHistory.length}</div>
      ...
      {routeHistory.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h4 className="text-lg font-medium text-gray-900 mb-2">No Draft Routes Available</h4>
          <p className="text-gray-500">Run the route planning program to create draft routes for review and approval.</p>
        </div>
      ) : (
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center">
                      <MdPeople className="w-6 h-6 text-orange-600" />
                    </div>
                    <div>
