...
const Footer = () => {
  ...
  const companyPath = location.pathname.split('/').filter(Boolean)[0] || '';
  const theme = getThemeForCompany(companyPath);
  const companyName = theme.footerCopyrightName || 'JAYS KERALA INNOVATIONS PRIVATE LIMITED';

  return (
    <footer className="bg-gray-900 text-gray-300 py-6 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-2">
          {!theme.hideTermsAndConditions && (
