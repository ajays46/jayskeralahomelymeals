                                                    ...
                                                    <div className="flex items-center gap-2.5 py-1">
                                                      ...
                                                      <div className="min-w-0 text-left">
                                                        <p className="text-gray-800 font-semibold text-xs">
                                                          {selectedFiles.length > 0 ? `Add more (${selectedFiles.length})` : 'Gallery / files'}
                                                        </p>
                                                        <p className="text-gray-500 text-[10px] leading-tight mt-0.5">Images & videos</p>
                                                      </div>
                                                    </div>
                                                  </label>
                                                </div>
                                                <div className="bg-amber-50/80 rounded-lg p-2 border border-dashed border-amber-300">
                                                  <label className="block cursor-pointer">
                                                    <input
                                                      type="file"
                                                      accept="image/*"
                                                    ...
                                                    <div className="flex items-center gap-2.5 py-1">
                                                      ...
                                                      <div className="min-w-0 text-left">
                                                        <p className="text-amber-900 font-semibold text-xs">Take photo</p>
                                                        <p className="text-amber-800/80 text-[10px] leading-tight mt-0.5">Camera on phone</p>
                                                      </div>
                                                    </div>
                                                  </label>
                                                </div>
                                                  ...
                                                  <label className="block cursor-pointer">
                                                    ...
                                                    <div className="flex items-center gap-2.5 py-1">
                                                      ...
                                                      <div className="min-w-0 text-left">
                                                        ...
                                                        <p className="text-gray-500 text-[10px] leading-tight mt-0.5">10MB img · 100MB video</p>
                                                      </div>
                                                    </div>
                                                  </label>
                                                </div>
                                                <div className="bg-blue-50/80 rounded-lg p-2 border border-dashed border-blue-300">
                                                  <label className="block cursor-pointer">
                                                    <input
                                                      type="file"
                                                      accept="image/*"
                                                    ...
                                                    <div className="flex items-center gap-2.5 py-1">
                                                      ...
                                                      <div className="min-w-0 text-left">
                                                        <p className="text-blue-900 font-semibold text-xs">Take photo</p>
                                                        <p className="text-blue-800/80 text-[10px] leading-tight mt-0.5">Camera on phone</p>
                                                      </div>
                                                    </div>
                                                  </label>
                                                </div>
